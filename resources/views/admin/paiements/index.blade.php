                ...
                <tbody>
                    @forelse($paiements as $paiement)
                        <tr>
                            ...
                            <td>{{ number_format($paiement->commission_montant, 0, ',', ' ') }} FCFA</td>
                            ...
                            <div class="d-flex justify-content-center align-item-center gap-1">
                                ...
                                <a href="{{ route('admin.paiements.show', $paiement->id) }}" class="btn btn-outline-info">
                                ...
                                <a href="{{ route('admin.paiements.edit', $paiement->id) }}" class="btn btn-outline-warning">
