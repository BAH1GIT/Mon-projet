...
@section('content')
    <h3 class="text-center m-2 h3">Toutes les missions</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center align-item-center gap-1">
                                ...
                                <a href="{{ route('admin.missions.show', $mission->id) }}" class="btn btn-outline-info">
                                ...
                                <a href="{{ route('admin.missions.edit', $mission->id) }}" class="btn btn-outline-warning">
                    ...
                    <li class="splide__slide mb-5">
                        <div class="card shadow-sm h-100">
                            <div class="card-body">
                                <h5 class=" mb-1">
                                    Titre:
                                    <span class="fw-bold">{{ $mission->title }}</span>
                                </h5>
                                <h5 class=" mb-1">
                                    Client:
                                    <span class="fw-bold">{{ $mission->client->name ?? '—' }}</span>
                                </h5>
                                <p class="mb-1">
                                    💰 Budget Max:
                                ...
                                <p class="mb-2">Status:
                                    <span class="badge bg-{{ $colors[$mission->status] ?? 'secondary' }}">
                                        {{ ucfirst(str_replace('_', ' ', $mission->status)) }}
                                    </span>
                                </p>
                                ...
                                <div class="d-flex justify-content-center align-item-center gap-1 mt-3">
