...
@section('content')
    <h2 class="mb-4 text-center h4 my-3">Mes Paiements</h2>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center align-item-center gap-1">
                            ...
                            <a href="{{ route('executant.paiements.show', $paiement->id) }}" class="btn btn-outline-info">
            ...
            @empty
                <tr>
                    <td colspan="7" class="text-center">Aucun paiement reçu</td>
                </tr>
            @endforelse
        </tbody>
    @endsection
